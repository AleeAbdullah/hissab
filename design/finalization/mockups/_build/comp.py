"""Component builders shared across sections.

These mirror the component contracts in 03-design-system.md §4. If a screen
needs a variant that is not expressible here, that is a signal the component
spec is incomplete — fix the spec, then add it here.
"""
