...
from lib import statusbar, homebar, nav, largetitle, tabbar, frame, phone, write, avatar, IC, tick
...
def build():
    ...
    def group_form(title, name, action, members_summary, saving=False):
        return (statusbar()
                ...
                + '<div class="scroll">'
                + '<div style="padding:16px 16px 4px;display:flex;justify-content:center">'
    ...
    actions = ('<div style="display:flex;gap:8px;padding:0 16px 4px">'
