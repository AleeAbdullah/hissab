...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ref={ref}
      className={cn(
        'border-input dark:bg-input/30 dark:active:bg-input/50 bg-background flex min-h-12 flex-row items-center justify-between gap-2 rounded-xl border px-3 py-2',
        Platform.select({
          ...
          <NativeOnlyAnimatedView
            ...
            <TextClassContext.Provider value="text-popover-foreground">
              <SelectPrimitive.Content
                className={cn(
                  'bg-popover border-border relative z-50 min-w-[8rem] rounded-[20px] border',
                  Platform.select({
                    web: cn(
...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      className={cn(
        'active:bg-accent group relative flex min-h-12 w-full flex-row items-center gap-2 rounded-xl py-2 pl-3 pr-10',
        Platform.select({
