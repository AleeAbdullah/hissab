    ...
    return (
      <Screen>
        <View className="flex-1 justify-center gap-2">
          ...
          >
            If an account exists for {email}, a reset link request has been
            recorded. Reset email delivery is coming later, so no link has been
            sent.
          </Text>
  ...
  return (
    <Screen>
      <AuthPageHeader
        ...
        description="Enter the email on your account to request a link for setting a new password."
      />
